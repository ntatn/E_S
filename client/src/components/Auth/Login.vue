    ...
    <div class="bg-gray-50  flex item-center justify-center ">
        <div class="bg-gray-100 flex  rounded-2xl shadow-lg max-w-3xl p-5">
            <div class="md:w-1/2 px-8 md:px-16 font-Poppins">
                ...
                <fwb-alert icon type="danger" v-if="isAuthored">
                ...
                <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
                    ...
                    <button name="btnSignIn" type="submit"
                ...
                <div class="mt-3 text-xs flex justify-between items-center text-[#002D74]">
                    ...
                    <router-link :to="{ name: 'register' }"
                        class="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">Đăng ký</router-link>
                </div>
            </div>
            <div class="w-1/2">
...
<script setup>
import { FwbAlert, FwbToast } from 'flowbite-vue'
</script>
<script>
export default {
    data() {
        return {
            ...
            typeOfToast: 'success',
            contents: 'Your has been sigup successfully'
        }
    },
    mounted() {
